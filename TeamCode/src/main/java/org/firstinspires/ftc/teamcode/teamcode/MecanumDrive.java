...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 509.25;
    ...
    public final GoBildaPinpointDriverRR localizer;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        localizer.setOffsets(103,222);//change
        localizer.setEncoderResolution(GoBildaPinpointDriverRR.GoBildaOdometryPods.goBILDA_4_BAR_POD);
        localizer.setEncoderDirections(GoBildaPinpointDriverRR.EncoderDirection.REVERSED, GoBildaPinpointDriverRR.EncoderDirection.FORWARD);
